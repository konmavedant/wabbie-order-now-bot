        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex justify-center lg:justify-end animate-slide-in-right">
            <div className="relative">
              ...
              {/* iPhone Frame */}
              <div className="relative bg-gradient-to-b from-gray-800 to-black rounded-[3rem] p-2 shadow-2xl transform hover:scale-105 transition-transform duration-300">
                {/* Side Buttons */}
                <div className="absolute left-[-3px] top-16 w-1 h-6 bg-gray-600 rounded-l-full"></div>
                <div className="absolute left-[-3px] top-24 w-1 h-12 bg-gray-600 rounded-l-full"></div>
                <div className="absolute left-[-3px] top-40 w-1 h-12 bg-gray-600 rounded-l-full"></div>
                <div className="absolute right-[-3px] top-20 w-1 h-16 bg-gray-600 rounded-r-full"></div>
                
                {/* iPhone Screen */}
                <div className="bg-black rounded-[2.5rem] overflow-hidden w-56 h-[480px] relative">
                  {/* Dynamic Island */}
                  <div className="absolute top-2 left-1/2 transform -translate-x-1/2 w-20 h-6 bg-black rounded-full z-30 border border-gray-800"></div>
                  
                  {/* Screen Content */}
                  <div className="bg-white rounded-[2.5rem] overflow-hidden w-full h-full relative">
                    {/* Status Bar */}
                    <div className="bg-[#075E54] pt-8 pb-2 px-4 flex justify-between items-center text-white text-xs font-medium">
                      <span>9:41</span>
                      <div className="flex items-center space-x-1">
                        ...
                        <div className="w-6 h-3 border border-white rounded-sm relative">
                          ...
                          <div className="w-0.5 h-1 bg-white rounded-r-sm absolute top-1 -right-0.5"></div>
                        </div>
                      </div>
                    </div>

                    {/* WhatsApp Header */}
                    <div className="bg-[#075E54] px-4 pb-3 flex items-center justify-between shadow-md">
                      <div className="flex items-center space-x-3">
                        <div className="w-9 h-9 bg-white rounded-full flex items-center justify-center overflow-hidden shadow-sm">
                          <img 
                      ...
                      <div className="flex items-center space-x-4">
                        <Video className="text-white w-5 h-5 hover:text-white/80 cursor-pointer" />
                        <Phone className="text-white w-5 h-5 hover:text-white/80 cursor-pointer" />
                        <MoreVertical className="text-white w-5 h-5 hover:text-white/80 cursor-pointer" />
                      </div>
                    </div>
                    
                    {/* Chat Messages */}
                    <div className="bg-[#ECE5DD] h-full p-4 space-y-3 overflow-hidden relative">
                      {/* Background Pattern */}
                      ...
                      {/* Welcome Message */}
                      <div className="flex">
                        <div className="bg-white rounded-lg rounded-bl-sm p-3 max-w-xs shadow-sm relative">
                          <div className="absolute -left-1 bottom-0 w-3 h-3 bg-white transform rotate-45"></div>
                          <p className="text-sm text-gray-800 font-medium">नमस्ते! Wabbie में आपका स्वागत है 🍽️</p>
                      ...
                      <div className="flex justify-end">
                        <div className="bg-[#DCF8C6] rounded-lg rounded-br-sm p-3 max-w-xs shadow-sm relative">
                          <div className="absolute -right-1 bottom-0 w-3 h-3 bg-[#DCF8C6] transform rotate-45"></div>
                      ...
                      <div className="flex">
                        <div className="bg-white rounded-lg rounded-bl-sm p-3 max-w-xs shadow-sm relative">
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-xs text-gray-500 mt-3">12:32</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex">
                        <div className="bg-white rounded-lg rounded-bl-sm p-3 max-w-xs shadow-sm relative">
                          <div className="absolute -left-1 bottom-0 w-3 h-3 bg-white transform rotate-45"></div>
                          <button className="bg-gradient-to-r from-primary to-primary-dark text-white px-4 py-2 rounded-lg text-sm font-medium w-full shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center space-x-2">
                            <span>Order Now</span>
                            <span>🛒</span>
                          </button>
                          <p className="text-xs text-gray-500 mt-3">12:32</p>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-[#F0F0F0] p-2 flex items-center space-x-2">
                      ...
                      <div className="w-10 h-10 bg-[#25D366] rounded-full flex items-center justify-center shadow-md hover:shadow-lg transition-shadow duration-200">
              ...
              {/* Floating Elements */}
              <div className="absolute -top-4 -right-4 bg-gradient-to-r from-[#25D366] to-[#128C7E] text-white px-3 py-1 rounded-full shadow-lg animate-bounce-gentle">
                <span className="text-xs font-bold">LIVE</span>
              </div>
              
              {/* Glow Effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-transparent rounded-[3rem] blur-2xl -z-10"></div>
            </div>
          </div>
        </div>
